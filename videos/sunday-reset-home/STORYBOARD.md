---
format: 1080x1920
message: "Sunday Reset for your Homeowner's Sentinel"
...
- transition_in: cut
- status: outline
- voiceover: "Stop trying to remember when to flush your water heater or vacuum your dryer vents."
...
- status: outline
- voiceover: "HVAC systems, gutters, and smoke detectors have random timelines. Missing them ruins appliances or threatens your home, but standard task apps force you to sign up and pay monthly."
...
- scene: clean, screen capture of neatclock.pro loading the 'Homeowner's Sentinel' preset in 1 click
- duration: 5s
- transition_in: wipe
- status: outline
- voiceover: "Go to neatclock.pro and select 'Home Sentinel'. It's 100% free, runs entirely offline in your browser, and generates a recurring schedule in one click."
...
- scene: clean minimalist graphic with the domain 'neatclock.pro/?preset=home' and a mobile sync QR code
- duration: 4s
- transition_in: cut
- status: outline
